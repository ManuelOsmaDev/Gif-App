...
export interface SearcGIFResponse {
  data:       Gif[];
...
export class Convert {
  public static toSearcGIFResponse(json: string): SearcGIFResponse {
      return cast(JSON.parse(json), r("SearcGIFResponse"));
  }

  public static searcGIFResponseToJson(value: SearcGIFResponse): string {
      return JSON.stringify(uncast(value, r("SearcGIFResponse")), null, 2);
  }
}
